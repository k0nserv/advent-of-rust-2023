...
mod tests {
    ...
    fn solve_day01() {
        ...
        assert_eq!(star_one(&input), 54968);
        assert_eq!(star_two(&input), 54094);
    }
    ...
    fn solve_day03() {
        ...
        assert_eq!(star_one(&input), 556057);
        assert_eq!(star_two(&input), 82824352);
    }
    ...
    #[test]
    fn solve_day06() -> Result<()> {
        use crate::day06::{star_one, star_two};

        let input = load_file("day06.txt");

        assert_eq!(star_one(&input)?, 393120);
        assert_eq!(star_two(&input)?, 36872656);
    ...
    fn solve_day07() {
        ...
        assert_eq!(star_one(&input), 241344943);
        assert_eq!(star_two(&input), 243101568);
    }

    #[test]
    fn solve_day08() -> Result<()> {
        use crate::day08::{star_one, star_two};

        let input = load_file("day08.txt");

        assert_eq!(star_one(&input)?, 13207);
        assert_eq!(star_two(&input)?, 12324145107121);
    ...
    fn solve_day09() {
        ...
        assert_eq!(star_one(&input), 1696140818);
        assert_eq!(star_two(&input), 1152);
    }
    ...
    fn solve_day11() {
        ...
        assert_eq!(star_one(&input), 10494813);
        assert_eq!(star_two(&input, 999_999), 840988812853);
    }
    ...
    fn solve_day12() {
        ...
        assert_eq!(star_one(&input), 7032);
        assert_eq!(star_two(&input), 1493340882140);
    }
    ...
    fn solve_day13() {
        ...
        assert_eq!(star_one(&input), 27202);
        assert_eq!(star_two(&input), 41566);
    }
